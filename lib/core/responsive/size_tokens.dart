...
class SizeTokens {
  // Padding
  static double get p2 => getProportionateScreenWidth(2);
  static double get p4 => getProportionateScreenWidth(4);
  static double get p6 => getProportionateScreenWidth(6);
  ...
  static double get p60 => getProportionateScreenWidth(60);
  ...
  static double get p97 => getProportionateScreenWidth(97);
  static double get p100 => getProportionateScreenWidth(100);
  static double get p120 => getProportionateScreenWidth(120);
  static double get p145 => getProportionateScreenWidth(145);
  static double get p200 => getProportionateScreenWidth(200);
  static double get p240 => getProportionateScreenWidth(240);
  static double get p280 => getProportionateScreenWidth(280);
  static double get p300 => getProportionateScreenWidth(300);

  // Radius
  static double get r4 => getProportionateScreenWidth(4);
  static double get r6 => getProportionateScreenWidth(6);
  static double get r8 => getProportionateScreenWidth(8);
  static double get r10 => getProportionateScreenWidth(10);
  static double get r12 => getProportionateScreenWidth(12);
  static double get r16 => getProportionateScreenWidth(16);
  static double get r20 => getProportionateScreenWidth(20);
  static double get r24 => getProportionateScreenWidth(24);
  static double get r32 => getProportionateScreenWidth(32);
  static double get r40 => getProportionateScreenWidth(40);
