DRYFIX BOYACI UYGULAMASI – AI GELİŞTİRME DÖKÜMANI (FINAL)

Bu doküman, Dryfix boyacıları için geliştirilecek kurumsal Flutter uygulamasında AI’nin kesin kurallarla ilerlemesi için yazılmıştır. AI kafasına göre karar veremez. Emin olmadığı her noktada sormak zorundadır. 

ARCHITECTURE (1)

1) DEĞİŞTİRİLEMEZ KURALLAR (TARTIŞMASIZ)
...
data, meta, pagination, status, message, errors vb. alanların tamamı
modele karşılık gelmek zorundadır.
...
Her ekranın widget’ları kendi klasöründe olmak zorundadır:
views/<feature>/widgets/

4) RESPONSIVE / ÖLÇÜ SİSTEMİ (ZORUNLU)
4.1 Sabit pixel ile ölçü vermek YASAK
...
7) NETWORK STANDARDI (TEK YERDEN)
7.1 ApiClient
...
11) AI İÇİN SON TALİMAT (EN ÖNEMLİ)
